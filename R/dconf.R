...
#' @param conf.level Confidence level (in decimal form). Set to 0.9 by default.
#' @param rounded The number of decimal places the reliability coefficients should be rounded to. Set to 3 by default.
#'
